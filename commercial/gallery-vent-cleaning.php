...
<title>Vent Cleaning - Examples of Dirty Vents</title>

<meta name="description" content="Professional vent cleaning services" />
<meta name="keywords" content="vent cleaning, duct cleaning, orange county, Los Angeles, OC, LA" />
<meta name="author" content="Ivan Rosas, Vent cleaning expert" />
...
<!--#include virtual="/includes/head-includes.txt" -->
</head>
...
<h2>Vent Cleaning Photo Gallery</h2>
...
<ul class="gallery_demo_unstyled" >
	<?php 
		$i = 0;
		foreach(scandir($_SERVER['DOCUMENT_ROOT'].'/images/duct_cleaning/gallery') as $file){
			if(preg_match('/\.((jpg)|(jpeg)|(gif)|(png))$/i',$file)){
				$i++;
				echo ($i == 1) ? "<li class='active'>" : '<li>';
				echo "<img src='/images/duct_cleaning/gallery/$file' title='duct cleaning' alt='vent cleaning' /></li>\n";
			}
		}
	?>
</ul>
